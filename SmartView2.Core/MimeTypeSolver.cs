...
// Type: SmartView2.Core.MimeTypeSolver
...
{
  public static class MimeTypeSolver
  {
    public static string GetMimeByFileType(string type)
    {
      ...
      {
        Logger.Instance.LogErrorFormat("Can't get mime for '{0}' file type.", (object) type.ToLower());
        return "";
      }
    }
  }
