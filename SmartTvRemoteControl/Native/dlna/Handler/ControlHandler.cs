...
namespace SmartTVRemoteControl.Native.DLNA.Handler
{
	internal class ControlHandler : IHttpHandler
	{
		...
		public HttpResponse HandleRequest(HttpRequest request)
		{
			...
			{
				httpResponse = new HttpResponse(request, HttpCode.InternalError, "text/xml", "<?xml version=\"1.0\" encoding=\"utf-8\" standalone=\"yes\"?><SOAP-ENV:Envelope SOAP-ENV:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Body><SOAP-ENV:Fault><faultcode>500</faultcode><faultstring /><detail><UPnPError xmlns=\"urn:schemas-upnp-org:control-1-0\"><errorCode>401</errorCode><errorDescription>Invalid Action</errorDescription></UPnPError></detail></SOAP-ENV:Fault></SOAP-ENV:Body></SOAP-ENV:Envelope>");
			}
			return httpResponse;
		}
