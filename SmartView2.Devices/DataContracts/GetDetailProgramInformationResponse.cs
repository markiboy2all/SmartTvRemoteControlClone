...
// Type: SmartView2.Devices.DataContracts.GetDetailProgramInformationResponse
...
{
  [XmlRoot("GetDetailProgramInformationResponse")]
  public class GetDetailProgramInformationResponse : SecondTvResponse
  {
    [XmlElement("DetailProgramInformation")]
    public string DetailProgramInformation { get; set; }
  }
}
