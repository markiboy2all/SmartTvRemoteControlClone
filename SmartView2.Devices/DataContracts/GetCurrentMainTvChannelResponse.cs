...
// Type: SmartView2.Devices.DataContracts.GetCurrentMainTvChannelResponse
...
{
  [XmlRoot("GetCurrentMainTVChannelResponse")]
  public class GetCurrentMainTvChannelResponse : SecondTvResponse
  {
    [XmlElement("CurrentChannel")]
