...
// Type: SmartView2.Devices.DataContracts.StartSecondTvViewResponse
...
{
  [XmlRoot("StartSecondTVViewResponse")]
  public class StartSecondTvViewResponse : SecondTvResponse
  {
    [XmlElement("SecondTVURL")]
    public string SecondTvUrl { get; set; }
  }
}
