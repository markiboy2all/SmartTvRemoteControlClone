...
// Type: SmartView2.Devices.DataContracts.GetCurrentChannelListTypeResponse
...
{
  [XmlRoot("GetCurrentChListTypeResponse")]
  public class GetCurrentChannelListTypeResponse : SecondTvResponse
  {
