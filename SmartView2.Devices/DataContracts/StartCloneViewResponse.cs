...
// Type: SmartView2.Devices.DataContracts.StartCloneViewResponse
...
{
  [XmlRoot("StartCloneViewResponse")]
  public class StartCloneViewResponse : SecondTvResponse
  {
    [XmlElement("CloneViewURL")]
    public string CloneViewUrl { get; set; }
  }
}
