...
// Type: SmartView2.Devices.DataContracts.GetChannelInformationResponse
...
{
  [XmlRoot("GetChannelInformationResponse")]
  public class GetChannelInformationResponse : SecondTvResponse
  {
    [XmlElement("Channel")]
