...
// Type: SmartView2.Devices.DataContracts.GetCurrentAntennaModeResponse
...
{
  [XmlRoot("GetCurrentAntennaModeResponse")]
  public class GetCurrentAntennaModeResponse : SecondTvResponse
  {
    [XmlElement("AntennaMode")]
