...
// Type: SmartView2.Devices.DataContracts.StartExternalSourceResponse
...
{
  [XmlRoot("StartExtSourceViewResponse")]
  public class StartExternalSourceResponse : SecondTvResponse
  {
    [XmlElement("ExtSourceViewURL")]
    public string ExternalSourceViewUrl { get; set; }
  }
}
