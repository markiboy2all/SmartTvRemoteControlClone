...
// Type: SmartView2.Devices.SecondTv.ISecondTvSecurityProvider
...
{
  public interface ISecondTvSecurityProvider
  {
    object EncryptData(object data);

    object DecryptData(object data);
  }
}
