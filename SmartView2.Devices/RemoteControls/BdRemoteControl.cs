...
// Type: SmartView2.Devices.RemoteControls.BdRemoteControl
...
{
  public class BdRemoteControl : MbrRemoteControl
  {
    public override RemoteControlType RemoteControlType => RemoteControlType.Bd;

    public BdRemoteControl(IKeySender tvKeySender, IKeySender mbrKeySender, MbrDevice device)
    ...
    protected override object GetHomeCode() => (object) MbrKeyCode.KEY_PIP_CHDOWN;
