...
// Type: SmartView2.Devices.RemoteControls.UnknownRemoteControl
...
{
  public class UnknownRemoteControl : BaseRemoteControl
  {
    public override RemoteControlType RemoteControlType => RemoteControlType.Unknown;

    public UnknownRemoteControl(IKeySender tvKeySender)
      : base(tvKeySender)
    {
    }
