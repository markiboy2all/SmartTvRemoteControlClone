...
// Type: SmartView2.Devices.RemoteControls.StbRemoteControl
...
{
  public class StbRemoteControl : MbrRemoteControl
  {
    public override RemoteControlType RemoteControlType => RemoteControlType.Stb;

    public StbRemoteControl(IKeySender tvKeySender, IKeySender mbrKeySender, MbrDevice device)
    ...
    protected override object GetInfoCode() => (object) MbrKeyCode.KEY_INFO;

    protected override object GetToolsCode() => (object) null;
    ...
    protected override object GetChannelUpCode() => (object) MbrKeyCode.KEY_CHUP;

    protected override object GetChannelDownCode() => (object) MbrKeyCode.KEY_CHDOWN;
    ...
    protected override object GetStbMenuCode() => (object) MbrKeyCode.KEY_MENU;
  }
}
