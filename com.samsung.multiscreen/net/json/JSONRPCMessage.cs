      ...
      if (this.map.ContainsKey("result"))
      {
        ...
        switch (obj)
        {
          ...
          case JObject _:
            ...
            IDictionary<string, object> dictionary1 = (IDictionary<string, object>) JsonConvert.DeserializeObject<Dictionary<string, object>>(jobject.ToString());
            dictionary1["success"] = (object) jobject["success"];
            return dictionary1;
          case bool? nullable:
            IDictionary<string, object> dictionary2 = (IDictionary<string, object>) new Dictionary<string, object>();
            dictionary2["success"] = (object) nullable;
            return dictionary2;
        }
      }
